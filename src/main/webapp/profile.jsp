			...
			<form>
				...
				<div class="form-group">
					<label for="firstName">user ID</label> <input type="text"
						id="firstName" name="cusid" value="${cus.id}" readonly>
				</div>
				<div class="form-group">
					<label for="firstName">Name</label> <input type="text"
						id="firstName" name="name" value="${cus.name}" readonly>
				</div>
				<div class="form-group">
					<label for="email">Email</label> <input type="text" id="email"
						name="email" value="${cus.email}" readonly>
				</div>
				<div class="form-group">
					<label for="contact">Contact</label> <input type="text"
						id="contact" name="contact" value="${cus.phone}" readonly>
				</div>
				<div class="form-group">
					<label for="firstName">Username</label> <input type="text"
						id="username" name="username" value="${cus.username}" readonly>
				</div>
				<div class="form-group">
					<label for="Password">Password</label> <input type="Password"
						id="Password" name="password" value="${cus.password}" readonly>
				</div>
				<div class="form-group">
					<label for="Faculty">Faculty</label> <input type="text"
						id="Faculty" name="faculty" value="${cus.faculty}" readonly>
				</div>
				<div class="form-group">
					<label for="Gender">Gender</label> <input type="text" id="Gender"
						name="gender" value="${cus.gender}" readonly>
				</div>
				<div class="form-group">
					<label for="Address">Address</label> <input type="text"
						id="address" name="address" value="${cus.address}" readonly>
				</div>

				<div class="form-group">
					<label for="lastName">Date of Birth</label> <input type="text"
						id="lastName" name="dob" value="${cus.dob}" readonly>
				</div>
